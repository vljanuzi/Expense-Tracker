...
GUIContainer<GUIGridLayout> aboutUs;

GUIContainer<GUIGridLayout> test;
KetaiLocation location;
KetaiCamera cam;
KetaiSQLite db;
String create_table_expenses = "CREATE TABLE expenses ( _id INTEGER PRIMARY KEY AUTOINCREMENT, description TEXT NOT NULL, price INTEGER NOT NULL );";
...
void setup() {
  ...
  guiControl.addScreen(aboutUs);        //then add it to the controller
